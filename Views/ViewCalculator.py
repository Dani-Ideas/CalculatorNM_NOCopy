...
B44 = Button(F, text="*", command=lambda: press("*"), font=("None 25 bold"),
...
B0 = Button(F, text="X", command=lambda: press("X"),font=("None 25 bold"), bd=4, width=5, bg="gray", activebackground="lightgray")
B0.grid(row=8, column=2)
root.mainloop()